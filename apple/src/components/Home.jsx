    ...
    <div className="home-wrapper">
      ...
      <div className="footer">
        <div className="container text-justify">
          <p>
            1.Must be at least 18. Apple or its trade-in partners reserve the
            right to refuse or limit any Trade In transaction for any reason.
            In‑store trade‑in requires presentation of a valid,
            government-issued photo ID (local law may require saving this
            information). Sales tax may be assessed on full value of new iPhone.
            ...
            Apple Card Monthly Installments terms are in the Customer Agreement.
